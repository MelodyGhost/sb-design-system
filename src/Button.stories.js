...
export const WithInterection = () => (
  <Button
    ButtonWrapper={StoryLinkWrapper}
    appearance="primary"
    href="https://github.com/melodyghost">
    Button
  </Button>
);

WithInterection.play = async ({ canvasElement }) => {
  // Assign canvas element to the root component
  const canvas = within(canvasElement);
  await userEvent.click(canvas.getByRole('link'));
};

WithInterection.storyName = 'button with interaction';
